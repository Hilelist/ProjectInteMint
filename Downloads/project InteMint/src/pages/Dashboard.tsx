    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="mt-4">
            <span className="text-sm text-red-600">↑ 8% from last week</span>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="mt-4">
            <span className="text-sm text-green-600">↑ 3 new trends</span>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="mt-4">
            <span className="text-sm text-red-600">5 require attention</span>
          </div>
        </div>
      </div>
              ...
              <div key={item} className="flex items-start space-x-4">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">
                    Competitor "TechCorp" updated their pricing
                  </p>
