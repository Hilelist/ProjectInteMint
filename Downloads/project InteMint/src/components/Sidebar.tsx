...
const menuItems = [
  ...
  { id: 'competitors', label: 'Competitor Tracker', icon: Target, path: '/competitors' },
  { id: 'trends', label: 'Market Trends', icon: TrendingUp, path: '/trends' },
  { id: 'alerts', label: 'Real-Time Alerts', icon: Bell, path: '/alerts' },
