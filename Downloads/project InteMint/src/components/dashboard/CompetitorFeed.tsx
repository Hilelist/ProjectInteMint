                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className={`px-2 py-1 text-xs rounded-full border ${getRiskColor(competitor.riskLevel)}`}>
                      {competitor.riskLevel.charAt(0).toUpperCase() + competitor.riskLevel.slice(1)} Risk
                    </span>
                  </div>
                  ...
                  <div className="space-y-1 text-sm text-gray-600">
                    {competitor.lastFunding && (
                      <p>
                        ...
                        {competitor.lastFunding.amount} ({competitor.lastFunding.round}) - {new Date(competitor.lastFunding.date).toLocaleDateString()}
                      </p>
                    )}
